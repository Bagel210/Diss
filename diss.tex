...
This project aimed to generate head motions solely from text by using many natural language processing to analyse the text and use that information to make head motions.  
...
TODO: conceptual\\
Talk about underlying models the we assume\\
how text information is related to head motions\\
text gives speaker independent information\\
text information is not enough, there is a lot of missing information needed \\
for this project we are only using the text\\
clarify limitation\\
\\

The goal of this project was to develop a system that was capable of synthesising life-like, realistic head motions from transcribed speech. 
In order to synthesise realistic head motions hypotheses about the ..
...
\begin{figure}
	\includegraphics[width=0.5\textwidth]{/traj/sine_out.png}
%	\caption{Basic System output trajectories}
	\includegraphics[width=0.5\textwidth]{traj/random_out.png}
%	\caption{Random System output trajectories}
	\includegraphics[width=0.5\textwidth]{traj/rule_out.png}
%	\caption{Rule Based System output trajectories}
	\includegraphics[width=0.5\textwidth]{traj/desmond_out.png}
%	\caption{Basic}
	\includegraphics[width=0.5\textwidth]{traj/jane_out.png}
%	\caption{Basic}
\end{figure}
