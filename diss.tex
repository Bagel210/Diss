...
drawbacks
-not natural for animator
- different results depending on order of rotation
- gimbal lock
...
To synthesise smooth head motions between random points multiple interpolation algorithms were considered. Spherical Linear Interpolation (Slerp) was the first that was considered and was already used in similar research \cite{rigid_head_motion}. 
