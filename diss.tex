...
Another type of preference testing is ABX testing, \citE{abx_testing} where the participant is shown three videos (A, B and X) as is asked "Is X more like A or B". Again, as mentioned with AB testing, if there is a large number of samples to evaluate this process can take a lot of time.
